...
return new class extends Migration
{
    ...
    {
        Schema::create('class_task_answer_media', function (Blueprint $table) {
            // Kolom ID menggunakan UUID sebagai primary key
            $table->uuid('id')->primary();
            // Foreign key ke tabel class_task_answers (yang ID-nya UUID)
    ...
    {
        Schema::dropIfExists('class_task_answer_media');
    }
};
